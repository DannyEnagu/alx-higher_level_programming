...
class TestRectangleHeight(unittest.TestCase):
    """Unittest for ``Rectangle`` instance attribute name ``height``"""
...
class TestRectangleX(unittest.TestCase):
    """Unittests for ``Rectangle`` instance attribute name ``x``"""
...
class TestRectangleY(unittest.TestCase):
    """Unittests for ``Rectangle`` instance attribute name ``y``"""
